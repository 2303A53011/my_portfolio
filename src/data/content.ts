...
export const skillGroups: SkillGroup[] = [
  ...
  },
  {
    ...
    skills: [
      { name: 'SIEM Architecture', tooltip: 'Splunk, Elastic, QRadar deployment' },
  ...
  },
  {
    ...
    skills: [
      { name: 'AWS Security', tooltip: 'GuardDuty, Security Hub, IAM hardening' },
    ],
  },
  {
    category: 'DevSecOps',
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Go', tooltip: 'High-performance security tools' },
      { name: 'JavaScript/TypeScript', tooltip: 'Full-stack security dashboards' },
    ],
  },
  {
...
export const certifications: Certification[] = [
  {
    ...
    issuerLogo: 'https://www.netacad.com/themes/custom/cisco/logo.svg',
  ...
  },
  {
    ...
    issuer: 'Microsoft',
    issuerLogo: 'https://learn.microsoft.com/en-us/media/logos/microsoft-logo.svg',
